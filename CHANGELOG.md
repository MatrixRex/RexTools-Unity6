...
### Changed
- Git Integration: Wrapped main content area and no-repository states in a ScrollView to prevent UI overflow in smaller editor windows while keeping the branded header and help box fixed at the top.
